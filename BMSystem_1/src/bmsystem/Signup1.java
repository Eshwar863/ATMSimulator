...
public class Signup1 extends JFrame implements ActionListener {
    ...
    **/
    ...
    System.out.println();
     ...
     String dbpincode = pincodetf.getText();
     try{
         if(dbname.equals("")){
     ...
     JOptionPane.showMessageDialog(null, "NAME IS REQ ");
             ...
             Conn c =new Conn();
             String query = "insert into signupone values('"+dbformno+"','"+dbname+"','"+dbfname+"','"+dbDob+"','"+dbgender+"','"+dbemail+"','"+dbmarital+"','"+dbaddress+"','"+dbcity+"','"+dbstate+"','"+dbpincode+"')";
     ...
     /**dbformno,dbname,dbfname,dbDob,dbgender,dbemail,dbmarital,dbaddress,dbcity,dbstate,dbpincode**/
     catch(Exception e){
